...
const Footer = () => {
  return (
    <>
      <footer className="bg-nutty font-bold" style={{ color: "white" }}>
          ...
          <div className="lg:flex lg:items-start lg:gap-8">
            ...
            <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
              <div className="col-span-2">
                <div>
                  ...
                  <p className="mt-4 text-gray-500">
                    Get monthly news about our new products, company updates,
                ...
                <form className="w-full">
                  ...
                  <div className="border  p-2  sm:flex sm:items-center sm:gap-4">
                    <input
                      ...
                      className="w-full bg-nutty border-none sm:text-sm"
                    />
              ...
              <div className="col-span-2 sm:col-span-1">
                <p className="font-lg text-gray-900">Services</p>
              ...
              <div className="col-span-2 sm:col-span-1">
                <p className="font-lg text-gray-900">Company</p>
